...
- ✅ Soporte para múltiples tipos de contenido (video, PDF, texto)
...
- ✅ Tests unitarios completos (27 tests en total)
...
### Problemas con permisos en archivos media
```bash
...
**Gadiel Ojeda**
- GitHub: [@Gadielo03](https://github.com/Gadielo03)
